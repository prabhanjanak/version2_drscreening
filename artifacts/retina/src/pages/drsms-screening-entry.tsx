...
const screeningFormSchema = z.object({
  ...
  address: z.string().min(1, "Address / Village is required"),
  phone: z.string().regex(/^\d{10}$/, "Phone number must be exactly 10 digits"),
  diabetesDuration: z.string().min(1, "Duration of diabetes is required"),
  systolicBP: z.string().min(1, "Systolic BP is required").regex(/^\d+$/, "Must be a number"),
  diastolicBP: z.string().min(1, "Diastolic BP is required").regex(/^\d+$/, "Must be a number"),
